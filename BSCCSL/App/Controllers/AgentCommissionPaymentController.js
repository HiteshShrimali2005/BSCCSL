angular.module("BSCCL").controller('AgentCommissionPaymentController', function ($scope, AppService, $state, $cookies, $filter, $location, $rootScope) {
        ...
        AgentCommissionReport = $('#tblAgentCommission').DataTable({
            ...
            "ajax": function (data, callback, settings) {
                ...
                $.ajax({
                    "dataType": 'json',
                    "type": "POST",
                    "url": urlpath + "AgentCommission/GetAgentCommissionList",
                    "data": data,
    ...
    $scope.ViewCommissionDetails = function () {
        ...
        if ($scope.ThreeYearProduct == true) {
            ProductType.push(8)
        }
        ...
        AppService.SaveData("AgentCommission", "GetCommissionSubData", NewObj).then(function (p1) {
            if (p1.data) {
