angular.module("BSCCL").controller('CreditInterestController', function ($scope, AppService, $state, $cookies, $filter, $location, $rootScope) {
    ...
    $scope.CreditInterest = function () {
        ...
        if (flag) {
            ...
            //}
            $scope.TransactionData.DescIndentify = 1
